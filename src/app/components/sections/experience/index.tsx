    ...
    <section className="flex flex-col justify-center pt-20 mx-4">
      ...
      <div className="relative pl-8 sm:pl-32 py-6 group">
        ...
        <div className="text-gray-500">
          <ul>
            <li>
              Création d'un tableau de bord mobile dédié à la visualisation des
              budgets des équipes institutaires
            </li>
            <li>
            ...
            <li>
              Utilisation de React Native avec des React Hooks et intégration de
              Redux pour le développement front-end
            </li>
            <li>
      ...
      <div className="relative pl-8 sm:pl-32 py-6 group">
        ...
        <div className="text-gray-500">
          <ul>
            ...
            <li>
              Engagement dans des dialogues approfondis avec les clients afin de
              saisir pleinement l'essence des projets
            </li>
            <li>
